...
#
# The relay never generates pairing tokens (SECURITY.md: "PC agent generates a
# single-use pairing token") — it only accepts, validates, and atomically
# consumes whatever token string the agent chose. Consumption happens once, at
